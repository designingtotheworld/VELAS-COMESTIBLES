...
export default function TopBanner() {
  ...
  return (
    <div className="bg-[#faf7f0] text-neutral-900 font-medium text-xs sm:text-sm py-2.5 px-4 sticky top-0 z-50 shadow-md border-b border-amber-500/30 overflow-hidden">
